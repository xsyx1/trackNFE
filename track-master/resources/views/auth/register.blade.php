                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-lg-8 mx-auto">
                                    ...
                                    <h4 class=" text-center login-heading mb-4">Cadastre-se no TrackCash:</h4>
                                    <form>
                                        <div class="card-body">
                                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                
                                                <input type="text" name="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Nome" value="{{ old('name') }}">
                                        ...
                                        <div class="custom-control custom-checkbox mb-3 text-center">
                                                <a style=" color: #C94A21;" href="{{ route('password.request') }}">Já possui uma conta? Fazer login!</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
